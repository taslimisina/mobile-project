...
public class ChecklistViewAdaptor extends RecyclerView.Adapter<ChecklistViewAdaptor.ChecklistItemViewHolder> {
    ...
    public ChecklistViewAdaptor(List<ChecklistItem> items) {
        this.items = items;
    }
