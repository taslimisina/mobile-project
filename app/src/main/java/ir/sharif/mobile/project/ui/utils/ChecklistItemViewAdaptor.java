...
import ir.sharif.mobile.project.ui.habits.Task;
import ir.sharif.mobile.project.ui.habits.TaskViewHandler;

public class ChecklistItemViewAdaptor extends RecyclerView.Adapter<ChecklistItemViewAdaptor.TaskViewHolder> {
...
//            this.view = itemView;
    ...
    public ChecklistItemViewAdaptor(List<Task> tasks, TaskViewHandler taskViewHandler, Context context) {
        this.tasks = tasks;
